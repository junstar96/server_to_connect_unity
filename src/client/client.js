...
import { configDataRule } from '../config/config.js';
...
const sendPacket = (socket, packet) => {
  ...
  console.log("입력 받음 : protomessage", protoMessages.common);
...
// 서버에 연결할 호스트와 포트
const HOST = configDataRule.server.host;
const PORT = configDataRule.server.port;
